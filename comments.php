...
<div id="comments" class="comments-area">
	<?php if ( have_comments() ) : ?>
		...
		<h2 class="comments-title">
			...
			// translators.
			echo wp_kses_post( sprintf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'wp-octopress' ), number_format_i18n( get_comments_number() ), '<span>' . get_the_title() . '</span>' ) );  // @codingStandardsIgnoreLine: @TODO: Fix _n here.
		...
		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
			<nav id="comment-nav-below" class="navigation" role="navigation">
					<h1 class="assistive-text section-heading"><?php esc_html_e( 'Comment navigation', 'wp-octopress' ); ?></h1>
		...
		<?php if ( ! comments_open() && get_comments_number() ) : ?>
			<p class="nocomments"><?php esc_html_e( 'Comments are closed.', 'wp-octopress' ); ?></p>
		<?php endif; ?>
