...
!function (context) {
    ...
    function insert(target, host, fn) 
    {
        ...
        each(
            normalize(query ? query(target) : target), function (t) {
                each(
                    self, function (el) {
    ...
    Bonzo.prototype = {
        ...
        appendTo: function (target, host) {
            return insert.call(
                this, target, host, function (t, el) {
                    t.appendChild(el);
                }
            );
        },
...
!function () {
    var exports = {}, module = { exports: exports }; !function (doc) {
        ...
        testEl.doScroll && doc.attachEvent(
            onreadystatechange, (ol = function ol() 
            {
